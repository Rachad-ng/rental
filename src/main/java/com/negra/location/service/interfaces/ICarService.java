...
public interface ICarService {
    ...
    Map<String, Object> getHomePageCars() throws DataNotFoundException;
    ...
    Map<String, Object> getListingDetailsCarDtoAndSimilarListingCarDtos(long id) throws DataNotFoundException;
